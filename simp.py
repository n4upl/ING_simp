...
class SimpReport:
    ...
    def __init__(self, args):
        self.args = args
        self.simp_report_date = self.args.date
        self.simp_code = self.args.simpcode
        self.cert_file = self.args.cert
        self.reports = []
    ...
    def send_soap_request(self, msg_id, rpt_id, date=None, rpt_format='XML'):
        ...
        r = requests.post(url=wsdl_url, cert=self.cert_file, data=soap_request, headers=headers)
...
def main():
    ...
    parser.add_argument("--cert", default=os.path.join(cwd, "554168.pem"), help="Path to the ING https transport certificate file (default: %(default)s)")
